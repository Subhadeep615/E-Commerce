...
const ProductList = () => {
    ...
    const { currency, products, seller, fetchProducts } = useContext(ShopContext)
    ...
    return (
        <section className="flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
                ...
                <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20">
                    <table className="md:table-auto table-fixed w-full overflow-hidden">
                        ...
                        <tbody className="text-sm text-gray-500">
                            {products.filter((product) => product.seller._id === seller._id).map((product) => (
